Sure, here is a Python program that solves the knight's tour problem with a CLI GUI:
...
This program allows the user to set the board size, the starting position, and whether the end position should be the same as the starting position. The program then solves the knight's tour problem and prints the solution to the console.